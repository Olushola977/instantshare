        ...
        <div className="flex xl-flex-row flex-col m-auto bg-white" style={{maxWidth: '1500px', borderRadius: '32px'}}>
            ...
            <div className="w-full p-5 flex-1 xl:min-w-620">
                <div className="flex items-center justify-between">
                    <div className="flex gap-2 items-center">
                        <a 
                            ...
                            className="bg-white h-9 w-9 rounded-full flex items-center justify-center text-black text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none"
                        >
                ...
                <div className="flex flex-wrap mt-6 gap-3">
                    ...
                    <input 
                        type="text" 
                        className="flex-1 border-gray-100 outlie-none border-2 padding-2 rounded-2xl focus:border-gray-300"
